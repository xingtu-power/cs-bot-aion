...
- [x] D2 自我介绍口径：随 A，采用「广汽集团旗下 GAC/AION/昊铂三大品牌」口径（品牌①统一用 GAC，不用「传祺」）
- [x] D3 昊铂英文：Hyper → HYPTEC
- [x] D4 品牌①命名：对外统一 **GAC**（2026-09-08 追加决策）
- [x] D5 转人工/留资/热线归属：统一 **GAC 专员 / GAC specialist**（2026-09-08 追加决策）
