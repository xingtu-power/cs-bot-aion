...
- **品牌合规护栏**(提示词 + `compliance.find_competitor`):只推 GAC/AION/HYPTEC(集团旗下三品牌),禁提/禁比其它品牌;知识缺失或无对应配置时改为"留联系方式转接 AION 专员/到店咨询"(4 语言)。
- **话题边界与丝滑拉回**(提示词):超出广汽/汽车范畴的问题(天气/新闻等)不展开答,改为自然桥接回 GAC 旗下品牌(如"好天气适合家庭出游→推荐 AION UT")并引导,跟随用户语言。
