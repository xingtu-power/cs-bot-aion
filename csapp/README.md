...
> 产品文档见 `../智能客服系统设计文档-v0.4.md`(v0.3 为设计稿,本版为当前实现)。
...
- **一次 LLM 调用/轮**:`respond` 输出 `{intent, question, response}`;回复按用户消息语言生成,无语言沿对话语言,不写死语言码。
...
- 指标:多语言意图准确率 ≈98%;单轮延迟 ~1-2s;泰文向量 recall@5 e5-large 0.186 vs MiniLM 0.129。
