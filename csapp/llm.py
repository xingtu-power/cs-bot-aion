...
f"SPEC STANDARD: when you quote range/performance, state the exact test standard (WLTP/NEDC/CLTC). Do NOT claim a value "
f"'is not' another standard or deny a standard exists — the same car may be quoted under different test cycles across "
f"markets. If you only have one standard's value, state it clearly.\n"
