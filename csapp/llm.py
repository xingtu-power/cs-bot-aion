...
f"acknowledge or change the subject.\n"
                  ...
                  f"do not cover the customer's request, or AION/GAC does not offer what they asked — that is a "
                  f"KNOWLEDGE GAP: do NOT guess or invent. Politely say you don't have that info, THEN gently CAPTURE "
                  f"THE LEAD: ask for a phone/email so a local GAC/AION specialist can follow up and provide the "
                  f"accurate info. Frame it as 'I can register your details and a local specialist will reach you with "
                  f"the exact info'. Do NOT just say 'contact the dealer' and stop — always offer to take the "
                  f"customer's contact details for a follow-up.\n"
